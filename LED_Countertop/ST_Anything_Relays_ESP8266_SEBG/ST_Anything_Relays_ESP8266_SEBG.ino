...
//******************************************************************************************
String str_ssid     = "SebG_2Ghz";                           //  <---You must edit this line!
String str_password = "2120Qwerty123456.";                   //  <---You must edit this line!
IPAddress ip(192, 168, 0, 150);       //Device IP Address       //  <---You must edit this line!
...
IPAddress hubIp(192, 168, 0, 167);    // smartthings/hubitat hub ip //  <---You must edit this line!
...
void setup()
{
  ...
  static st::S_TimedRelay sensor1(F("relaySwitch1"), PIN_TIMEDRELAY_1, LOW, false, 500, 250, 1);
  static st::S_TimedRelay sensor2(F("relaySwitch2"), PIN_TIMEDRELAY_1, LOW, false, 500, 250, 2);
